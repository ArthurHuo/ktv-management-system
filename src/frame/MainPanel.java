...
public class MainPanel extends JPanel {
	...
	public void showAllRoomsData() {
		...
		showData(roomDaoImpl.getRoomsData(), head);
...
//		addRooms.addActionListener(tableListener);
	...
	public void showExpiredRoomsData() {
		...
		RoomDaoImpl roomDaoImpl = new RoomDaoImpl();
		showData(roomDaoImpl.getExpiredRoomsData(), head);
		JPopupMenu menu = new JPopupMenu();
	...
	public void showRoomTypesData() {
		...
		showData(roomTypeDaoImpl.getRoomTypesData(), head);
	...
	public void showRoomsBookedData() {
		...
		showData(bookingDaoImpl.getBookingsData(), head);
	...
	public void showRoomTakenData() {
		...
		RoomDaoImpl roomDaoImpl = new RoomDaoImpl();
		Object[] head = { "房号", "房间类型", "房间消费", "开始时间", "结束时间" };
		showData(roomDaoImpl.getRoomsTakenData(), head);
		JPopupMenu menu = new JPopupMenu();
	...
	public void showFoodsData() {
		...
		showData(foodDaoImpl.getFoodsData(), head);
		JPopupMenu menu = new JPopupMenu();
		JMenuItem checkout = new JMenuItem("    添加食品    ");
		JMenuItem edit = new JMenuItem("    编辑食品   ");
